        ...
        <div className="w-full overflow-x-auto">
          <table className="w-full whitespace-no-wrap">
            ...
            <tbody className="bg-white divide-y divide-gray-100 dark:divide-gray-700 dark:bg-gray-800 text-gray-700 dark:text-gray-400">
              ...
              <tr className="">
                <td className="px-4 py-3">
                  <span className="font-semibold uppercase text-xs"> 3075</span>
                </td>
                <td className="px-4 py-3">
                  <span className="text-sm">Sep 15, 2023</span>
                </td>
                <td className="px-4 py-3">
                  <span className="text-sm">BuildMeProduct</span>
                </td>
                <td className="px-4 py-3">
                  <span className="text-sm">buildmeproduct@gmail.com</span>
                </td>
                <td className="px-4 py-3">
                  <span className="text-sm font-medium"></span>
                </td>
                <td className="px-4 py-3">
                  <div className="flex justify-end text-right">
                    <div className="p-2 cursor-pointer text-gray-400 hover:text-green-600">
                      <a href="/customer-order/6504be17c11b4c0008553075">
                        <p data-tip="true" data-for="view" className="text-xl">
                          <svg
                            stroke="currentColor"
                            fill="none"
              ...
              <tr className="">
                <td className="px-4 py-3">
                  <span className="font-semibold uppercase text-xs"> 171e</span>
                </td>
                <td className="px-4 py-3">
                  <span className="text-sm">Sep 12, 2023</span>
                </td>
                <td className="px-4 py-3">
                  <span className="text-sm">Jahongir Muminov</span>
                </td>
                <td className="px-4 py-3">
                  <span className="text-sm">jahongirmuminov80@gmail.com</span>
                </td>
                <td className="px-4 py-3">
                  <span className="text-sm font-medium"></span>
                </td>
                <td className="px-4 py-3">
                  <div className="flex justify-end text-right">
                    <div className="p-2 cursor-pointer text-gray-400 hover:text-green-600">
                      <a href="/customer-order/64ffff79c7700b0008c8171e">
                        <p data-tip="true" data-for="view" className="text-xl">
                          <svg
                            stroke="currentColor"
                            fill="none"
