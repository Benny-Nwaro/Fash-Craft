const DashboardTable = () => {
  return (
    <div>
      <div className="w- full min-w-0 rounded-lg ring-1 border-slate-500  ring-opacity-4 bg-white dark:bg-gray-800 m shadow-xs overflow-hidden bg-whit dark:bg-gray-800 mb-5 ml-2 mr-2 shadow-md">
        <div className="p-4">
