const DashboardTable = () => {
    return (
      <div>
        <div className="w-full  min-w-0 rounded-lg ring-1 border-slate-500  ring-opacity-4 bg-white  shadow-xs overflow-hidden mt-8 shadow-md">
          <div className="p-4">
        ...
        <div className="w-full overflow-hidden border border-gray-200 rounded-lg ring-1 ring-black ring-opacity-5 my-8  shadow-md">
